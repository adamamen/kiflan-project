...
<body>
    ...
    <!-- Breadcrumb Start -->
    <div class="breadcrumb-wrap br-21 bg-f">
        <div class="container">
    ...
    <section class="terms-wrap pt-100 pb-100">
        <div class="container">
            ...
            <div class="container">
                <center>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/uBXGmSbCTKM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </center>
            </div>
        </div>
    </section>
