...
<body>
    ...
    <!-- Breadcrumb Start -->
    <div class="breadcrumb-wrap br-23 bg-f">
        <div class="container">
    ...
    <section class="terms-wrap pt-100 pb-100">
        <div class="container">
            ...
            <div class="row">
                ...
                @if (substr($value['assets'], 30, 8) == 'Interior')
                <div class="col-md-4">
            ...
            <div class="row">
                @foreach ($gallery as $value)
                @if (substr($value['assets'], 30, 8) == 'Exterior')
                <div class="col-md-4">
                    <a class="single-service-img" data-fancybox="gallery" href="{{ $value['assets'] }}">
                        <img src="{{ $value['assets'] }}" alt="Image">
                    </a>
    ...
    <section class="terms-wrap pt-100 pb-100">
        <div class="container">
            ...
            <div class="container">
                <center>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/bSRUjcHRpjE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </center>
            </div>
        </div>
    </section>
