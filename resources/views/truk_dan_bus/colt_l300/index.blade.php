...
<body>
    ...
    <!-- Breadcrumb Start -->
    <div class="breadcrumb-wrap br-24 bg-f">
        <div class="container">
            <div class="breadcrumb-title">
                <h2>Colt L300</h2>
                <ul class="breadcrumb-menu list-style">
                    <li><a href="#">Katalog </a></li>
                    <li><a href="#">Truk dan Bus </a></li>
                    <li>Colt L300</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                            <div class="product-card-two">
                                ...
                                <div class="product-info">
                                    <h3><a href="{{ $value['picture_harga'] }}" data-fancybox="gallery">{{ $value['nama'] }}</a></h3>
    ...
    <section class="terms-wrap pt-100 pb-100">
        <div class="container">
            ...
            <div class="row">
                ...
                @if (substr($value['assets'], 28, 8) == 'Interior')
                <div class="col-md-4">
            ...
            <div class="row">
                @foreach ($gallery as $value)
                @if (substr($value['assets'], 28, 8) == 'Exterior')
                <div class="col-md-4">
                    <a class="single-service-img" data-fancybox="gallery" href="{{ $value['assets'] }}">
                        <img src="{{ $value['assets'] }}" alt="Image">
                    </a>
    ...
    <section class="terms-wrap pt-100 pb-100">
        <div class="container">
            ...
            <div class="container">
                <center>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/MnMd9niuZjA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </center>
            </div>
        </div>
    </section>
